...
public class FundsController {
	...
	/*
	 * handleCalcualte() subtracts savings & emergency fund from remaining funds.
	 * @param event: passed when the user clicks on calcBtn
	 */
	@FXML
	 ...
	 * @param event: this is passed when the user clicks on saveBtn
	 */
	@FXML
